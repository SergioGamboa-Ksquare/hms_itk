...
| ---------------- | :--: | ---: |
| Patient  |  ^ Extra blank line above!
```ts
interface patient
{
...
```
|    This module is necessary beacause it will be the main user of the app, we need a way to identication, that provide us the main information about the user and a way to login into the system. |
